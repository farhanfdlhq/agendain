...
// `logoUrl` diterima dari server component (page.tsx) yang sudah membacanya dari
// settings — jadi logo yang benar ada di HTML pertama, tanpa fetch klien dan
// tanpa kedip placeholder saat direfresh.
