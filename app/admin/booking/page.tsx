...
export default function AdminBookingPage() {
  ...
  const columns = useMemo(
    () => createColumns(handleStatusChange, handleDelete, setSelectedBooking),
    [handleStatusChange, handleDelete, setSelectedBooking],
  );
      ...
      return (
        <div className="flex flex-col items-center justify-center space-y-3 h-64">
          ...
          <p className="text-sm text-muted-foreground">
            Koneksi internet terputus. Silakan periksa jaringan Anda lalu coba
            lagi.
          </p>
      ...
      return (
        <div className="p-4 w-full">
          <EmptyState
            ...
            description="Belum ada riwayat booking atau pesanan yang dicari tidak ada."
          />
        </div>
      );
    }
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case "paid":
        return "text-emerald-700 bg-emerald-100 dark:bg-emerald-900/30 dark:text-emerald-400 border-emerald-200 dark:border-emerald-800";
      case "cancelled":
        return "text-destructive bg-destructive/10 border-destructive/20";
      default:
        return "text-amber-700 bg-amber-100 dark:bg-amber-900/30 dark:text-amber-400 border-amber-200 dark:border-amber-800";
    }
  };
  ...
  return (
    <div className="flex flex-col gap-6 w-full max-w-6xl mx-auto py-4">
      <AdminHeader
        ...
        description="Kelola daftar pemesanan dari pelanggan."
      />
            ...
            <div className="space-y-6 mt-4">
              <div className="flex flex-col gap-1">
                ...
                <strong className="text-lg font-mono">
                  #BKG-{selectedBooking.id.toString().padStart(4, "0")}
                </strong>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <a
                    href={`https://wa.me/${selectedBooking.noWa.replace(/\D/g, "")}`}
                    target="_blank"
                    rel="noreferrer"
              ...
              <div className="flex flex-col gap-1">
                ...
                <strong className="font-medium">
                  {selectedBooking.openTrip?.nama || "Paket Dihapus"}
                </strong>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <strong className="font-medium">
                    {selectedBooking.jumlahPax} Orang
                  </strong>
                </div>
              </div>
