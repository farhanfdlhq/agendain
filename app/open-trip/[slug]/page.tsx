          ...
          <div className={styles.sidebar}>
            <div className={styles.resCard}>
              ...
              <div className={styles.waOption}>
                ...
                <a href={`https://wa.me/${settingsObj.whatsapp_number?.replace(/\D/g, '') || "6281234567890"}?text=Halo%20Agendain,%20saya%20tertarik%20dengan%20open%20trip%20${encodeURIComponent(pkg?.nama || '')}`} 
