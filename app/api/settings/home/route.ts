  ...
  try {
    ...
    if (!setting) {
      return NextResponse.json({
        ...
        heroSubtitle_en:
          "Plan your dream journey with the experts. Transparent, trusted, and memorable.",
        heroSubtitleColor: "",
        ...
        ctaTitleColor: "",
        ctaText:
          "Diskusikan rencana liburan impian Anda bersama tim kami secara gratis.",
        ...
        ctaBtn2Link: "https://wa.me/6281995264565",
        ctaBtn2Color: "",
        ctaBtn2HoverColor: "",
        ctaBtn2TextColor: "",
