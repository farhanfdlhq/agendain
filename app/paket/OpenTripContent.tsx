  ...
  return (
    <div className={styles.page}>
      <HeroHeader 
        ...
        title={<>{t('openTrip.hero.title1')}<br />{t('openTrip.hero.title2')}<br />{t('openTrip.hero.title3')} <span className={styles.textGold}>Agendain.</span></>}
        minHeight="70vh"
        paddingBottom="120px"
        textAlign="left"
      />
      ...
      <div className={styles.content}>
        <div className={styles.container}>
          ...
          <div className={styles.sectionHeader}>
            ...
            <h2 className={styles.sectionTitle}>{t('openTrip.section.title1')}<br/>{t('openTrip.section.title2')}</h2>
          </div>
